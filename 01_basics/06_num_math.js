...
console.log((Math.random()*10) + 1 );              // output , diff range 
console.log((Math.random()*10) + 1 );
console.log(Math.floor(Math.random()*10) + 1 );     // we used the math floor to wrap up for the min number 


const min  = 10                                     // for minimum for the given  number 
